...
const Sidebar = () => {
    ...
    return (
        <div className="h-screen w-64 bg-gray-900 text-white flex flex-col fixed left-0 top-0 overflow-y-auto z-50">
            ...
            {/* Seção Admin - Só mostra se for Admin */}
            {user?.role === 'ROLE_ADMIN' && (
                <>
                    ...
                    <Link
                        to="/admin/users"
                        className={`flex items-center px-3 py-2.5 rounded-lg transition-all duration-200 group ${
                            isActive('/admin/users') ? 'bg-primary-600 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white'
                        }`}
                    >
                    ...
                    <Link
                        to="/admin/tenants"
                        className={`flex items-center px-3 py-2.5 rounded-lg transition-all duration-200 group ${
                            isActive('/admin/tenants') ? 'bg-primary-600 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white'
                        }`}
                    >
